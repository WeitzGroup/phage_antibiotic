...
% We will measure the effect of Sub-MIC to MIC antibiotic levels on
...
for mic = 1:length(mic_levels),
        ...
        [y, TB, time] = simRHM_WT(Ki, Io, B*0.5, B*0.5, P, dose*mic_levels(mic), anti_name);
        ...
        title({['Antibiotic (' num2str(mic_levels(mic)) ' MIC)+ Phage + Immune']; "Inoculum proportions: 50% B_P, 50% B_A"}, 'FontSize', 20, 'fontweight', 'bold')
