...
% thus phages can replicate inside BA bacteria)

% EC_50 for phage-sensitive strain, calculated from the new MIC value for
% this strain
ec_bp= p.ec_bp;
% delta, modulates the level of phage-resistance of the
