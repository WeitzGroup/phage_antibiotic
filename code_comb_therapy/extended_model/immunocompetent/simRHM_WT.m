...
%         (8) delta_P - level of phage resistance for antibiotic-sensitive
%         strain
...
function [y, TB, time ] = simRHM_WT(Ki, immune, Bp, Ba, phage, varargin)
    ...
    if strcmp('CP', anti_name) % Ciprofloxacin parameters
        ...
        p.kkill = 18.5;
        % EC_50, antibiotic-sensitive strain, antibiotic concentration when kkill/2
        p.ec = 0.3697;
