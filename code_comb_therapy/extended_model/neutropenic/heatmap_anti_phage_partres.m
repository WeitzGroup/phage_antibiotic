%% Code for the robustness analysis of the partial resistance model: Antibiotic + Phage therapeutic
...
% Simulate the phage-antibiotic therapy model for varied
...
caxis([min(matrix(:))-2e8 1e10]) % set colorbar axis limits
colormap(cmap);
...
title({"Antibiotic + Phages"; "MIC_{CP} for B_{P} = 0.172 \mug/ml, MIC_{CP} for B_{A} = 0.014 \mug/ml"}, 'FontSize', 20)
