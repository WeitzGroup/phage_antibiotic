...
% host given a phage-sensitive inoculum
[y, TB, time] = simRHM(Ki, Io, B, 0, P, dose, anti_name, delta_P);
...
title({"Phage-Antibiotic combination against a B_{P} inoculum"; "MIC_{CP} for B_{P}= 0.172n\mug/ml, MIC_{CP} for B_{A} = 0.014 \mug/ml"}, 'FontSize', 20)