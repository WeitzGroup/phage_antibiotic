...
% Neutropenic host 
% Inoculum: Antibiotic-sensitive inoculum (BA)
...
[y, TB, time] = simRHM(Ki, Io, 0, B, P, dose, anti_name);
...
title({"Phages + Antibiotic against a B_{A} inoculum"; "Heterogeneous mixing model"}, 'FontSize', 20)
