%Function to simulate rpsODE for immunodeficient hosts (or an in vitro
%context where the immune response is neglected)
...
%         (6) antibiotic - antibiotic constant conc., (7) Antibiotic name
...
function [ y, TB, time ] = simRPS(Ki, immune, Bp, Ba, phage, varargin )
