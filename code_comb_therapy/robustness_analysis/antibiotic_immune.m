...
% This code simulates the antibiotic + immune response effects on mixed
...
title('Antibiotic + Immune response', 'FontSize', 20)
...
hold off
ta = annotation('textarrow',[0.66 0.76], [0.25 0.15], 'units', 'normalized', 'String','B_{A}','FontSize',16, 'fontweight', 'bold', 'Linewidth',2);
%text(20.2, 39.5, 'B_{A}', 'FontSize',16,'fontweight', 'bold')
