% Notes: This code generates the histogram from Figure S7, it takes the 
% data generated from the parameter sensitivity analysis
% ('param_sens_AP_API.m') and plots the histogram of the percentage of
% infection clearance for both AP and API regimes.
...
% load results from the parameter sensitivity analysis
load('thresh_api.mat')
load('thresh_ap.mat')
...
load('extinction_vec.mat') 
load('perc_extinction_vec.mat') 


load('extinction_vec_ap.mat') 
load('perc_extinction_vec_ap.mat')
...
plot([0.62 0.62], [159 159], 'bs', 'markersize', 8, 'Linewidth', 2)
...
xlabel('Percentage of infection clearance')
...
% figure(2)
% % Visualize the heatmaps for a sample of perturbed parameter sets
% for indice = 1:16
% 
%     %fig = figure(1);
%     subplot(4, 4, indice);
